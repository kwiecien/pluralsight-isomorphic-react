...
const useLiveData = argv.useLiveData === "true"; // cross-env NODE-ENV=development babel-node server --useLiveData=true
...
app.get(['/', '/questions/:id'], function* (req, res) {
    ...
    if (req.params.id) {
        ...
        const response = yield getQuestions(question_id);
    ...
    if (useServerRender) {
        ...
        index = index.replace(`<%= preloadedApplication %>`, `Please wait till App is loaded`)
    }
    res.send(index);
});
